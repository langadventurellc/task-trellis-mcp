...
describe("E2E Workflow - Prerequisites", () => {
  ...
  describe("Simple Prerequisite Chains", () => {
    it("should handle linear dependency chain A -> B -> C", async () => {
      ...
      const taskA = await client.callTool("create_issue", {
        type: "task",
      ...
      const taskB = await client.callTool("create_issue", {
        type: "task",
        title: "Task B - Middle",
        status: "open",
      ...
      const taskC = await client.callTool("create_issue", {
        type: "task",
        title: "Task C - Final",
        status: "open",
    ...
    it("should handle parallel prerequisites", async () => {
      ...
      const prereq1 = await client.callTool("create_issue", {
        type: "task",
      ...
      const prereq2 = await client.callTool("create_issue", {
        type: "task",
      ...
      const mainTask = await client.callTool("create_issue", {
        type: "task",
  ...
  describe("Complex Dependency Graphs", () => {
    it("should handle diamond dependency pattern", async () => {
      ...
      const taskD = await client.callTool("create_issue", {
        type: "task",
    ...
    it("should handle cross-type dependencies", async () => {
      ...
      const task1Result = await client.callTool("create_issue", {
        type: "task",
      ...
      const task2Result = await client.callTool("create_issue", {
        type: "task",
  ...
  describe("Partial Prerequisites", () => {
    it("should handle wont-do prerequisites", async () => {
      ...
      const mainResult = await client.callTool("create_issue", {
        type: "task",
    ...
    it("should handle mixed internal and external prerequisites", async () => {
      ...
      const internalResult = await client.callTool("create_issue", {
        type: "task",
