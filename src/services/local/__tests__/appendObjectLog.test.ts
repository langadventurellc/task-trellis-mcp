...
import { appendObjectLog } from "../appendObjectLog";

describe("appendObjectLog", () => {
  ...
  it("should successfully append to object log", async () => {
    ...
    const result = await appendObjectLog(
      mockRepository,
      "T-test-task",
      "New log entry",
    );
  ...
  it("should handle empty contents string", async () => {
    ...
    const result = await appendObjectLog(mockRepository, "T-test-task", "");
