...
The results provide issue summaries (TrellisObjectSummary instances) containing id, type, title, status, priority, parent, prerequisites, childrenIds, labels, created, updated, and externalIssueId (when set) fields to enable efficient filtering and further operations.`,
  inputSchema: {
    type: "object",
    properties: {
      type: {
