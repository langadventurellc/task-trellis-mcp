...
describe("filterUnavailableObjects", () => {
  ...
  it("should include objects with prerequisites that are done", () => {
    const objects: TrellisObject[] = [
  ...
  it("should include objects with prerequisites that are wont-do", () => {
    const objects: TrellisObject[] = [
  ...
  it("should exclude objects with prerequisites that are not done or wont-do", () => {
    const objects: TrellisObject[] = [
  ...
  it("should handle empty input array", () => {
    const result = filterUnavailableObjects([]);
  ...
  it("should handle circular prerequisites", () => {
    const objects: TrellisObject[] = [
